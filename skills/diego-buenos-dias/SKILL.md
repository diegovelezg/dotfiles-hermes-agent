...
Para cada fuente, ejecutá `delegate_task` con DeepSeek R1. **Si una fuente falla, continuar con las demás** — no abortar todo el proceso. Guardar resultados parciales en `~/.hermes/skills/diego-buenos-dias/output/research-YYYY-MM-DD.json`.
